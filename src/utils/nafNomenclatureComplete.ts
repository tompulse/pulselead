...
// Classes NAF (615 classes officielles INSEE complètes)
export const NAF_CLASSES: Record<string, { label: string; groupe: string }> = {
  ...
  // Division 02 - Sylviculture
  '02.10': { label: 'Sylviculture et autres activités forestières', groupe: '02.1' },
  '02.20': { label: 'Exploitation forestière', groupe: '02.2' },
  '02.30': { label: 'Récolte de produits forestiers non ligneux poussant à l\'état sauvage', groupe: '02.3' },
  '02.40': { label: 'Services de soutien à l\'exploitation forestière', groupe: '02.4' },
  // Division 03 - Pêche et aquaculture
  '03.11': { label: 'Pêche en mer', groupe: '03.1' },
  '03.12': { label: 'Pêche en eau douce', groupe: '03.1' },
  '03.21': { label: 'Aquaculture en mer', groupe: '03.2' },
  '03.22': { label: 'Aquaculture en eau douce', groupe: '03.2' },
  
  // ===== Section B - Industries extractives =====
  // Division 05 - Extraction de houille et de lignite
  '05.10': { label: 'Extraction de houille', groupe: '05.1' },
  '05.20': { label: 'Extraction de lignite', groupe: '05.2' },
  // Division 06 - Extraction d'hydrocarbures
  '06.10': { label: 'Extraction de pétrole brut', groupe: '06.1' },
  '06.20': { label: 'Extraction de gaz naturel', groupe: '06.2' },
  // Division 07 - Extraction de minerais métalliques
  '07.10': { label: 'Extraction de minerais de fer', groupe: '07.1' },
  '07.21': { label: 'Extraction de minerais d\'uranium et de thorium', groupe: '07.2' },
  '07.29': { label: 'Extraction d\'autres minerais de métaux non ferreux', groupe: '07.2' },
  // Division 08 - Autres industries extractives
  '08.11': { label: 'Extraction de pierres ornementales et de construction, de calcaire industriel, de gypse, de craie et d\'ardoise', groupe: '08.1' },
  '08.12': { label: 'Exploitation de gravières et sablières, extraction d\'argiles et de kaolin', groupe: '08.1' },
  '08.91': { label: 'Extraction des minéraux chimiques et d\'engrais minéraux', groupe: '08.9' },
  '08.92': { label: 'Extraction de tourbe', groupe: '08.9' },
  '08.93': { label: 'Production de sel', groupe: '08.9' },
  '08.99': { label: 'Autres activités extractives n.c.a.', groupe: '08.9' },
  // Division 09 - Services de soutien aux industries extractives
  '09.10': { label: 'Activités de soutien à l\'extraction d\'hydrocarbures', groupe: '09.1' },
  '09.90': { label: 'Activités de soutien aux autres industries extractives', groupe: '09.9' },
  
  // ===== Section C - Industrie manufacturière =====
  // Division 10 - Industries alimentaires
  '10.11': { label: 'Transformation et conservation de la viande de boucherie', groupe: '10.1' },
  '10.12': { label: 'Transformation et conservation de la viande de volaille', groupe: '10.1' },
  '10.13': { label: 'Préparation de produits à base de viande', groupe: '10.1' },
  '10.20': { label: 'Transformation et conservation de poisson, de crustacés et de mollusques', groupe: '10.2' },
  '10.31': { label: 'Transformation et conservation de pommes de terre', groupe: '10.3' },
  '10.32': { label: 'Préparation de jus de fruits et légumes', groupe: '10.3' },
  '10.39': { label: 'Autre transformation et conservation de fruits et légumes', groupe: '10.3' },
  '10.41': { label: 'Fabrication d\'huiles et graisses', groupe: '10.4' },
  '10.42': { label: 'Fabrication de margarine et graisses comestibles similaires', groupe: '10.4' },
  '10.51': { label: 'Exploitation de laiteries et fabrication de fromage', groupe: '10.5' },
  '10.52': { label: 'Fabrication de glaces et sorbets', groupe: '10.5' },
  '10.61': { label: 'Travail des grains', groupe: '10.6' },
  '10.62': { label: 'Fabrication de produits amylacés', groupe: '10.6' },
  '10.71': { label: 'Fabrication de pain et de pâtisserie fraîche', groupe: '10.7' },
  '10.72': { label: 'Fabrication de biscuits, biscottes et pâtisseries de conservation', groupe: '10.7' },
  '10.73': { label: 'Fabrication de pâtes alimentaires', groupe: '10.7' },
  '10.81': { label: 'Fabrication de sucre', groupe: '10.8' },
  '10.82': { label: 'Fabrication de cacao, chocolat et de produits de confiserie', groupe: '10.8' },
  '10.83': { label: 'Transformation du thé et du café', groupe: '10.8' },
  '10.84': { label: 'Fabrication de condiments et assaisonnements', groupe: '10.8' },
  '10.85': { label: 'Fabrication de plats préparés', groupe: '10.8' },
  '10.86': { label: 'Fabrication d\'aliments homogénéisés et diététiques', groupe: '10.8' },
  '10.89': { label: 'Fabrication d\'autres produits alimentaires n.c.a.', groupe: '10.8' },
  '10.91': { label: 'Fabrication d\'aliments pour animaux de ferme', groupe: '10.9' },
  '10.92': { label: 'Fabrication d\'aliments pour animaux de compagnie', groupe: '10.9' },
  // Division 11 - Fabrication de boissons
  '11.01': { label: 'Production de boissons alcooliques distillées', groupe: '11.0' },
  '11.02': { label: 'Production de vin (de raisin)', groupe: '11.0' },
  '11.03': { label: 'Fabrication de cidre et de vins de fruits', groupe: '11.0' },
  '11.04': { label: 'Production d\'autres boissons fermentées non distillées', groupe: '11.0' },
  '11.05': { label: 'Fabrication de bière', groupe: '11.0' },
  '11.06': { label: 'Fabrication de malt', groupe: '11.0' },
  '11.07': { label: 'Industrie des eaux de table et des boissons rafraîchissantes', groupe: '11.0' },
  // Division 12 - Fabrication de produits à base de tabac
  '12.00': { label: 'Fabrication de produits à base de tabac', groupe: '12.0' },
  // Division 13 - Fabrication de textiles
  '13.10': { label: 'Préparation de fibres textiles et filature', groupe: '13.1' },
  '13.20': { label: 'Tissage', groupe: '13.2' },
  '13.30': { label: 'Ennoblissement textile', groupe: '13.3' },
  '13.91': { label: 'Fabrication d\'étoffes à mailles', groupe: '13.9' },
  '13.92': { label: 'Fabrication d\'articles textiles, sauf habillement', groupe: '13.9' },
  '13.93': { label: 'Fabrication de tapis et moquettes', groupe: '13.9' },
  '13.94': { label: 'Fabrication de ficelles, cordes et filets', groupe: '13.9' },
  '13.95': { label: 'Fabrication de non-tissés, sauf habillement', groupe: '13.9' },
  '13.96': { label: 'Fabrication d\'autres textiles techniques et industriels', groupe: '13.9' },
  '13.99': { label: 'Fabrication d\'autres textiles n.c.a.', groupe: '13.9' },
  // Division 14 - Industrie de l'habillement
  '14.11': { label: 'Fabrication de vêtements en cuir', groupe: '14.1' },
  '14.12': { label: 'Fabrication de vêtements de travail', groupe: '14.1' },
  '14.13': { label: 'Fabrication de vêtements de dessus', groupe: '14.1' },
  '14.14': { label: 'Fabrication de vêtements de dessous', groupe: '14.1' },
  '14.19': { label: 'Fabrication d\'autres vêtements et accessoires', groupe: '14.1' },
  '14.20': { label: 'Fabrication d\'articles en fourrure', groupe: '14.2' },
  '14.31': { label: 'Fabrication d\'articles chaussants à mailles', groupe: '14.3' },
  '14.39': { label: 'Fabrication d\'autres articles à mailles', groupe: '14.3' },
  // Division 15 - Industrie du cuir et de la chaussure
  '15.11': { label: 'Apprêt et tannage des cuirs ; préparation et teinture des fourrures', groupe: '15.1' },
  '15.12': { label: 'Fabrication d\'articles de voyage, de maroquinerie et de sellerie', groupe: '15.1' },
  '15.20': { label: 'Fabrication de chaussures', groupe: '15.2' },
  // Division 16 - Travail du bois
  '16.10': { label: 'Sciage et rabotage du bois', groupe: '16.1' },
  '16.21': { label: 'Fabrication de placage et de panneaux de bois', groupe: '16.2' },
  '16.22': { label: 'Fabrication de parquets assemblés', groupe: '16.2' },
  '16.23': { label: 'Fabrication de charpentes et d\'autres menuiseries', groupe: '16.2' },
  '16.24': { label: 'Fabrication d\'emballages en bois', groupe: '16.2' },
  '16.29': { label: 'Fabrication d\'objets divers en bois ; fabrication d\'objets en liège, vannerie et sparterie', groupe: '16.2' },
  // Division 17 - Industrie du papier et du carton
  '17.11': { label: 'Fabrication de pâte à papier', groupe: '17.1' },
  '17.12': { label: 'Fabrication de papier et de carton', groupe: '17.1' },
  '17.21': { label: 'Fabrication de papier et carton ondulés et d\'emballages en papier ou en carton', groupe: '17.2' },
  '17.22': { label: 'Fabrication d\'articles en papier à usage sanitaire ou domestique', groupe: '17.2' },
  '17.23': { label: 'Fabrication d\'articles de papeterie', groupe: '17.2' },
  '17.24': { label: 'Fabrication de papiers peints', groupe: '17.2' },
  '17.29': { label: 'Fabrication d\'autres articles en papier ou en carton', groupe: '17.2' },
  // Division 18 - Imprimerie et reproduction d'enregistrements
  '18.11': { label: 'Imprimerie de journaux', groupe: '18.1' },
  '18.12': { label: 'Autre imprimerie (labeur)', groupe: '18.1' },
  '18.13': { label: 'Activités de pré-presse', groupe: '18.1' },
  '18.14': { label: 'Reliure et activités connexes', groupe: '18.1' },
  '18.20': { label: 'Reproduction d\'enregistrements', groupe: '18.2' },
  // Division 19 - Cokéfaction et raffinage
  '19.10': { label: 'Cokéfaction', groupe: '19.1' },
  '19.20': { label: 'Raffinage du pétrole', groupe: '19.2' },
  // Division 20 - Industrie chimique
  '20.11': { label: 'Fabrication de gaz industriels', groupe: '20.1' },
  '20.12': { label: 'Fabrication de colorants et de pigments', groupe: '20.1' },
  '20.13': { label: 'Fabrication d\'autres produits chimiques inorganiques de base', groupe: '20.1' },
  '20.14': { label: 'Fabrication d\'autres produits chimiques organiques de base', groupe: '20.1' },
  '20.15': { label: 'Fabrication de produits azotés et d\'engrais', groupe: '20.1' },
  '20.16': { label: 'Fabrication de matières plastiques de base', groupe: '20.1' },
  '20.17': { label: 'Fabrication de caoutchouc synthétique', groupe: '20.1' },
  '20.20': { label: 'Fabrication de pesticides et d\'autres produits agrochimiques', groupe: '20.2' },
  '20.30': { label: 'Fabrication de peintures, vernis, encres et mastics', groupe: '20.3' },
  '20.41': { label: 'Fabrication de savons, détergents et produits d\'entretien', groupe: '20.4' },
  '20.42': { label: 'Fabrication de parfums et de produits pour la toilette', groupe: '20.4' },
  '20.51': { label: 'Fabrication de produits explosifs', groupe: '20.5' },
  '20.52': { label: 'Fabrication de colles', groupe: '20.5' },
  '20.53': { label: 'Fabrication d\'huiles essentielles', groupe: '20.5' },
  '20.59': { label: 'Fabrication d\'autres produits chimiques n.c.a.', groupe: '20.5' },
  '20.60': { label: 'Fabrication de fibres artificielles ou synthétiques', groupe: '20.6' },
  // Division 21 - Industrie pharmaceutique
  '21.10': { label: 'Fabrication de produits pharmaceutiques de base', groupe: '21.1' },
  '21.20': { label: 'Fabrication de préparations pharmaceutiques', groupe: '21.2' },
  // Division 22 - Fabrication de produits en caoutchouc et en plastique
  '22.11': { label: 'Fabrication et rechapage de pneumatiques', groupe: '22.1' },
  '22.19': { label: 'Fabrication d\'autres articles en caoutchouc', groupe: '22.1' },
  '22.21': { label: 'Fabrication de plaques, feuilles, tubes et profilés en matières plastiques', groupe: '22.2' },
  '22.22': { label: 'Fabrication d\'emballages en matières plastiques', groupe: '22.2' },
  '22.23': { label: 'Fabrication d\'éléments en matières plastiques pour la construction', groupe: '22.2' },
  '22.29': { label: 'Fabrication d\'autres articles en matières plastiques', groupe: '22.2' },
  // Division 23 - Fabrication d'autres produits minéraux non métalliques
  '23.11': { label: 'Fabrication de verre plat', groupe: '23.1' },
  '23.12': { label: 'Façonnage et transformation du verre plat', groupe: '23.1' },
  '23.13': { label: 'Fabrication de verre creux', groupe: '23.1' },
  '23.14': { label: 'Fabrication de fibres de verre', groupe: '23.1' },
  '23.19': { label: 'Fabrication et façonnage d\'autres articles en verre, y compris verre technique', groupe: '23.1' },
  '23.20': { label: 'Fabrication de produits réfractaires', groupe: '23.2' },
  '23.31': { label: 'Fabrication de carreaux en céramique', groupe: '23.3' },
  '23.32': { label: 'Fabrication de briques, tuiles et produits de construction, en terre cuite', groupe: '23.3' },
  '23.41': { label: 'Fabrication d\'articles céramiques à usage domestique ou ornemental', groupe: '23.4' },
  '23.42': { label: 'Fabrication d\'appareils sanitaires en céramique', groupe: '23.4' },
  '23.43': { label: 'Fabrication d\'isolateurs et pièces isolantes en céramique', groupe: '23.4' },
  '23.44': { label: 'Fabrication d\'autres produits céramiques à usage technique', groupe: '23.4' },
  '23.49': { label: 'Fabrication d\'autres produits céramiques', groupe: '23.4' },
  '23.51': { label: 'Fabrication de ciment', groupe: '23.5' },
  '23.52': { label: 'Fabrication de chaux et plâtre', groupe: '23.5' },
  '23.61': { label: 'Fabrication d\'éléments en béton pour la construction', groupe: '23.6' },
  '23.62': { label: 'Fabrication d\'éléments en plâtre pour la construction', groupe: '23.6' },
  '23.63': { label: 'Fabrication de béton prêt à l\'emploi', groupe: '23.6' },
  '23.64': { label: 'Fabrication de mortiers et bétons secs', groupe: '23.6' },
  '23.65': { label: 'Fabrication d\'ouvrages en fibre-ciment', groupe: '23.6' },
  '23.69': { label: 'Fabrication d\'autres ouvrages en béton, en ciment ou en plâtre', groupe: '23.6' },
  '23.70': { label: 'Taille, façonnage et finissage de pierres', groupe: '23.7' },
  '23.91': { label: 'Fabrication de produits abrasifs', groupe: '23.9' },
  '23.99': { label: 'Fabrication d\'autres produits minéraux non métalliques n.c.a.', groupe: '23.9' },
  // Division 24 - Métallurgie
  '24.10': { label: 'Sidérurgie', groupe: '24.1' },
  '24.20': { label: 'Fabrication de tubes, tuyaux, profilés creux et accessoires correspondants en acier', groupe: '24.2' },
  '24.31': { label: 'Étirage à froid de barres', groupe: '24.3' },
  '24.32': { label: 'Laminage à froid de feuillards', groupe: '24.3' },
  '24.33': { label: 'Profilage à froid par formage ou pliage', groupe: '24.3' },
  '24.34': { label: 'Tréfilage à froid', groupe: '24.3' },
  '24.41': { label: 'Production de métaux précieux', groupe: '24.4' },
  '24.42': { label: 'Métallurgie de l\'aluminium', groupe: '24.4' },
  '24.43': { label: 'Métallurgie du plomb, du zinc ou de l\'étain', groupe: '24.4' },
  '24.44': { label: 'Métallurgie du cuivre', groupe: '24.4' },
  '24.45': { label: 'Métallurgie des autres métaux non ferreux', groupe: '24.4' },
  '24.46': { label: 'Élaboration et transformation de matières nucléaires', groupe: '24.4' },
  '24.51': { label: 'Fonderie de fonte', groupe: '24.5' },
  '24.52': { label: 'Fonderie d\'acier', groupe: '24.5' },
  '24.53': { label: 'Fonderie de métaux légers', groupe: '24.5' },
  '24.54': { label: 'Fonderie d\'autres métaux non ferreux', groupe: '24.5' },
  // Division 25 - Fabrication de produits métalliques
  '25.11': { label: 'Fabrication de structures métalliques et de parties de structures', groupe: '25.1' },
  '25.12': { label: 'Fabrication de portes et fenêtres en métal', groupe: '25.1' },
  '25.21': { label: 'Fabrication de radiateurs et de chaudières pour le chauffage central', groupe: '25.2' },
  '25.29': { label: 'Fabrication d\'autres réservoirs, citernes et conteneurs métalliques', groupe: '25.2' },
  '25.30': { label: 'Fabrication de générateurs de vapeur, à l\'exception des chaudières pour le chauffage central', groupe: '25.3' },
  '25.40': { label: 'Fabrication d\'armes et de munitions', groupe: '25.4' },
  '25.50': { label: 'Forge, emboutissage, estampage ; métallurgie des poudres', groupe: '25.5' },
  '25.61': { label: 'Traitement et revêtement des métaux', groupe: '25.6' },
  '25.62': { label: 'Usinage', groupe: '25.6' },
  '25.71': { label: 'Fabrication de coutellerie', groupe: '25.7' },
  '25.72': { label: 'Fabrication de serrures et de ferrures', groupe: '25.7' },
  '25.73': { label: 'Fabrication d\'outillage', groupe: '25.7' },
  '25.91': { label: 'Fabrication de fûts et emballages métalliques similaires', groupe: '25.9' },
  '25.92': { label: 'Fabrication d\'emballages métalliques légers', groupe: '25.9' },
  '25.93': { label: 'Fabrication d\'articles en fils métalliques, de chaînes et de ressorts', groupe: '25.9' },
  '25.94': { label: 'Fabrication de vis et de boulons', groupe: '25.9' },
  '25.99': { label: 'Fabrication d\'autres produits métalliques n.c.a.', groupe: '25.9' },
  // Division 26 - Fabrication de produits informatiques, électroniques et optiques
  '26.11': { label: 'Fabrication de composants électroniques', groupe: '26.1' },
  '26.12': { label: 'Fabrication de cartes électroniques assemblées', groupe: '26.1' },
  '26.20': { label: 'Fabrication d\'ordinateurs et d\'équipements périphériques', groupe: '26.2' },
  '26.30': { label: 'Fabrication d\'équipements de communication', groupe: '26.3' },
  '26.40': { label: 'Fabrication de produits électroniques grand public', groupe: '26.4' },
  '26.51': { label: 'Fabrication d\'instruments et d\'appareils de mesure, d\'essai et de navigation', groupe: '26.5' },
  '26.52': { label: 'Horlogerie', groupe: '26.5' },
  '26.60': { label: 'Fabrication d\'équipements d\'irradiation médicale, d\'équipements électromédicaux et électrothérapeutiques', groupe: '26.6' },
  '26.70': { label: 'Fabrication de matériels optique et photographique', groupe: '26.7' },
  '26.80': { label: 'Fabrication de supports magnétiques et optiques', groupe: '26.8' },
  // Division 27 - Fabrication d'équipements électriques
  '27.11': { label: 'Fabrication de moteurs, génératrices et transformateurs électriques', groupe: '27.1' },
  '27.12': { label: 'Fabrication de matériel de distribution et de commande électrique', groupe: '27.1' },
  '27.20': { label: 'Fabrication de piles et d\'accumulateurs électriques', groupe: '27.2' },
  '27.31': { label: 'Fabrication de câbles de fibres optiques', groupe: '27.3' },
  '27.32': { label: 'Fabrication d\'autres fils et câbles électroniques ou électriques', groupe: '27.3' },
  '27.33': { label: 'Fabrication de matériel d\'installation électrique', groupe: '27.3' },
  '27.40': { label: 'Fabrication d\'appareils d\'éclairage électrique', groupe: '27.4' },
  '27.51': { label: 'Fabrication d\'appareils électroménagers', groupe: '27.5' },
  '27.52': { label: 'Fabrication d\'appareils ménagers non électriques', groupe: '27.5' },
  '27.90': { label: 'Fabrication d\'autres matériels électriques', groupe: '27.9' },
  // Division 28 - Fabrication de machines et équipements n.c.a.
  '28.11': { label: 'Fabrication de moteurs et turbines, à l\'exception des moteurs d\'avions et de véhicules', groupe: '28.1' },
  '28.12': { label: 'Fabrication d\'équipements hydrauliques et pneumatiques', groupe: '28.1' },
  '28.13': { label: 'Fabrication d\'autres pompes et compresseurs', groupe: '28.1' },
  '28.14': { label: 'Fabrication d\'autres articles de robinetterie', groupe: '28.1' },
  '28.15': { label: 'Fabrication d\'engrenages et d\'organes mécaniques de transmission', groupe: '28.1' },
  '28.21': { label: 'Fabrication de fours et brûleurs', groupe: '28.2' },
  '28.22': { label: 'Fabrication de matériel de levage et de manutention', groupe: '28.2' },
  '28.23': { label: 'Fabrication de machines et d\'équipements de bureau (à l\'exception des ordinateurs et équipements périphériques)', groupe: '28.2' },
  '28.24': { label: 'Fabrication d\'outillage portatif à moteur incorporé', groupe: '28.2' },
  '28.25': { label: 'Fabrication d\'équipements aérauliques et frigorifiques industriels', groupe: '28.2' },
  '28.29': { label: 'Fabrication de machines diverses d\'usage général', groupe: '28.2' },
  '28.30': { label: 'Fabrication de machines agricoles et forestières', groupe: '28.3' },
  '28.41': { label: 'Fabrication de machines-outils pour le travail des métaux', groupe: '28.4' },
  '28.49': { label: 'Fabrication d\'autres machines-outils', groupe: '28.4' },
  '28.91': { label: 'Fabrication de machines pour la métallurgie', groupe: '28.9' },
  '28.92': { label: 'Fabrication de machines pour l\'extraction ou la construction', groupe: '28.9' },
  '28.93': { label: 'Fabrication de machines pour l\'industrie agro-alimentaire', groupe: '28.9' },
  '28.94': { label: 'Fabrication de machines pour les industries textiles', groupe: '28.9' },
  '28.95': { label: 'Fabrication de machines pour les industries du papier et du carton', groupe: '28.9' },
  '28.96': { label: 'Fabrication de machines pour le travail du caoutchouc ou des plastiques', groupe: '28.9' },
  '28.99': { label: 'Fabrication d\'autres machines d\'usage spécifique n.c.a.', groupe: '28.9' },
  // Division 29 - Industrie automobile
  '29.10': { label: 'Construction de véhicules automobiles', groupe: '29.1' },
  '29.20': { label: 'Fabrication de carrosseries et remorques', groupe: '29.2' },
  '29.31': { label: 'Fabrication d\'équipements électriques et électroniques automobiles', groupe: '29.3' },
  '29.32': { label: 'Fabrication d\'autres équipements automobiles', groupe: '29.3' },
  // Division 30 - Fabrication d'autres matériels de transport
  '30.11': { label: 'Construction de navires et de structures flottantes', groupe: '30.1' },
  '30.12': { label: 'Construction de bateaux de plaisance', groupe: '30.1' },
  '30.20': { label: 'Construction de locomotives et d\'autre matériel ferroviaire roulant', groupe: '30.2' },
  '30.30': { label: 'Construction aéronautique et spatiale', groupe: '30.3' },
  '30.40': { label: 'Construction de véhicules militaires de combat', groupe: '30.4' },
  '30.91': { label: 'Fabrication de motocycles', groupe: '30.9' },
  '30.92': { label: 'Fabrication de bicyclettes et de véhicules pour invalides', groupe: '30.9' },
  '30.99': { label: 'Fabrication d\'autres équipements de transport n.c.a.', groupe: '30.9' },
  // Division 31 - Fabrication de meubles
  '31.01': { label: 'Fabrication de meubles de bureau et de magasin', groupe: '31.0' },
  '31.02': { label: 'Fabrication de meubles de cuisine', groupe: '31.0' },
  '31.03': { label: 'Fabrication de matelas', groupe: '31.0' },
  '31.09': { label: 'Fabrication d\'autres meubles', groupe: '31.0' },
  // Division 32 - Autres industries manufacturières
  '32.11': { label: 'Frappe de monnaie', groupe: '32.1' },
  '32.12': { label: 'Fabrication d\'articles de joaillerie et bijouterie', groupe: '32.1' },
  '32.13': { label: 'Fabrication d\'articles de bijouterie fantaisie et articles similaires', groupe: '32.1' },
  '32.20': { label: 'Fabrication d\'instruments de musique', groupe: '32.2' },
  '32.30': { label: 'Fabrication d\'articles de sport', groupe: '32.3' },
  '32.40': { label: 'Fabrication de jeux et jouets', groupe: '32.4' },
  '32.50': { label: 'Fabrication d\'instruments et de fournitures à usage médical et dentaire', groupe: '32.5' },
  '32.91': { label: 'Fabrication d\'articles de brosserie', groupe: '32.9' },
  '32.99': { label: 'Autres activités manufacturières n.c.a.', groupe: '32.9' },
  // Division 33 - Réparation et installation de machines et d'équipements
  '33.11': { label: 'Réparation d\'ouvrages en métaux', groupe: '33.1' },
  '33.12': { label: 'Réparation de machines et équipements mécaniques', groupe: '33.1' },
  '33.13': { label: 'Réparation de matériels électroniques et optiques', groupe: '33.1' },
  '33.14': { label: 'Réparation d\'équipements électriques', groupe: '33.1' },
  '33.15': { label: 'Réparation et maintenance navale', groupe: '33.1' },
  '33.16': { label: 'Réparation et maintenance d\'aéronefs et d\'engins spatiaux', groupe: '33.1' },
  '33.17': { label: 'Réparation et maintenance d\'autres équipements de transport', groupe: '33.1' },
  '33.19': { label: 'Réparation d\'autres équipements', groupe: '33.1' },
  '33.20': { label: 'Installation de machines et d\'équipements industriels', groupe: '33.2' },
  
  // ===== Section D - Production et distribution d'électricité, gaz =====
  '35.11': { label: 'Production d\'électricité', groupe: '35.1' },
  '35.12': { label: 'Transport d\'électricité', groupe: '35.1' },
  '35.13': { label: 'Distribution d\'électricité', groupe: '35.1' },
  '35.14': { label: 'Commerce d\'électricité', groupe: '35.1' },
  '35.21': { label: 'Production de combustibles gazeux', groupe: '35.2' },
  '35.22': { label: 'Distribution de combustibles gazeux par conduites', groupe: '35.2' },
  '35.23': { label: 'Commerce de combustibles gazeux par conduites', groupe: '35.2' },
  '35.30': { label: 'Production et distribution de vapeur et d\'air conditionné', groupe: '35.3' },
  
  // ===== Section E - Eau, déchets =====
  '36.00': { label: 'Captage, traitement et distribution d\'eau', groupe: '36.0' },
  '37.00': { label: 'Collecte et traitement des eaux usées', groupe: '37.0' },
  '38.11': { label: 'Collecte des déchets non dangereux', groupe: '38.1' },
  '38.12': { label: 'Collecte des déchets dangereux', groupe: '38.1' },
  '38.21': { label: 'Traitement et élimination des déchets non dangereux', groupe: '38.2' },
  '38.22': { label: 'Traitement et élimination des déchets dangereux', groupe: '38.2' },
  '38.31': { label: 'Démantèlement d\'épaves', groupe: '38.3' },
  '38.32': { label: 'Récupération de déchets triés', groupe: '38.3' },
  '39.00': { label: 'Dépollution et autres services de gestion des déchets', groupe: '39.0' },
  ...
  '46.11': { label: 'Intermédiaires du commerce en matières premières agricoles, animaux vivants, matières premières textiles et produits semi-finis', groupe: '46.1' },
  '46.12': { label: 'Intermédiaires du commerce en combustibles, métaux, minéraux et produits chimiques', groupe: '46.1' },
  '46.13': { label: 'Intermédiaires du commerce en bois et matériaux de construction', groupe: '46.1' },
  '46.14': { label: 'Intermédiaires du commerce en machines, équipements industriels, navires et avions', groupe: '46.1' },
  '46.15': { label: 'Intermédiaires du commerce en meubles, articles de ménage et quincaillerie', groupe: '46.1' },
  '46.16': { label: 'Intermédiaires du commerce en textiles, habillement, fourrures, chaussures et articles en cuir', groupe: '46.1' },
  '46.17': { label: 'Intermédiaires du commerce en denrées, boissons et tabac', groupe: '46.1' },
  '46.18': { label: 'Intermédiaires spécialisés dans le commerce d\'autres produits spécifiques', groupe: '46.1' },
  '46.19': { label: 'Intermédiaires du commerce en produits divers', groupe: '46.1' },
  '46.21': { label: 'Commerce de gros de céréales, de tabac non manufacturé, de semences et d\'aliments pour le bétail', groupe: '46.2' },
  '46.22': { label: 'Commerce de gros de fleurs et plantes', groupe: '46.2' },
  '46.23': { label: 'Commerce de gros d\'animaux vivants', groupe: '46.2' },
  '46.24': { label: 'Commerce de gros de cuirs et peaux', groupe: '46.2' },
  '46.31': { label: 'Commerce de gros de fruits et légumes', groupe: '46.3' },
  '46.32': { label: 'Commerce de gros de viandes et de produits à base de viande', groupe: '46.3' },
  '46.33': { label: 'Commerce de gros de produits laitiers, œufs, huiles et matières grasses comestibles', groupe: '46.3' },
  '46.34': { label: 'Commerce de gros de boissons', groupe: '46.3' },
  '46.35': { label: 'Commerce de gros de produits à base de tabac', groupe: '46.3' },
  '46.36': { label: 'Commerce de gros de sucre, chocolat et confiserie', groupe: '46.3' },
  '46.37': { label: 'Commerce de gros de café, thé, cacao et épices', groupe: '46.3' },
  '46.38': { label: 'Commerce de gros d\'autres produits alimentaires, y compris poissons, crustacés et mollusques', groupe: '46.3' },
  '46.39': { label: 'Commerce de gros non spécialisé de denrées, boissons et tabac', groupe: '46.3' },
  '46.41': { label: 'Commerce de gros de textiles', groupe: '46.4' },
  '46.42': { label: 'Commerce de gros d\'habillement et de chaussures', groupe: '46.4' },
  '46.43': { label: 'Commerce de gros d\'appareils électroménagers', groupe: '46.4' },
  '46.44': { label: 'Commerce de gros de vaisselle, verrerie et produits d\'entretien', groupe: '46.4' },
  '46.45': { label: 'Commerce de gros de parfumerie et de produits de beauté', groupe: '46.4' },
  '46.46': { label: 'Commerce de gros de produits pharmaceutiques', groupe: '46.4' },
  '46.47': { label: 'Commerce de gros de meubles, de tapis et d\'appareils d\'éclairage', groupe: '46.4' },
  '46.48': { label: 'Commerce de gros d\'articles d\'horlogerie et de bijouterie', groupe: '46.4' },
  '46.49': { label: 'Commerce de gros d\'autres biens domestiques', groupe: '46.4' },
  '46.51': { label: 'Commerce de gros d\'ordinateurs, d\'équipements informatiques périphériques et de logiciels', groupe: '46.5' },
  '46.52': { label: 'Commerce de gros de composants et d\'équipements électroniques et de télécommunication', groupe: '46.5' },
  '46.61': { label: 'Commerce de gros de matériel agricole', groupe: '46.6' },
  '46.62': { label: 'Commerce de gros de machines-outils', groupe: '46.6' },
  '46.63': { label: 'Commerce de gros de machines pour l\'extraction, la construction et le génie civil', groupe: '46.6' },
  '46.64': { label: 'Commerce de gros de machines pour l\'industrie textile et l\'habillement', groupe: '46.6' },
  '46.65': { label: 'Commerce de gros de mobilier de bureau', groupe: '46.6' },
  '46.66': { label: 'Commerce de gros d\'autres machines et équipements de bureau', groupe: '46.6' },
  '46.69': { label: 'Commerce de gros d\'autres machines et équipements', groupe: '46.6' },
  '46.71': { label: 'Commerce de gros de combustibles et de produits annexes', groupe: '46.7' },
  '46.72': { label: 'Commerce de gros de minerais et métaux', groupe: '46.7' },
  '46.73': { label: 'Commerce de gros de bois, de matériaux de construction et d\'appareils sanitaires', groupe: '46.7' },
  '46.74': { label: 'Commerce de gros de quincaillerie et fournitures pour plomberie et chauffage', groupe: '46.7' },
  '46.75': { label: 'Commerce de gros de produits chimiques', groupe: '46.7' },
  '46.76': { label: 'Commerce de gros d\'autres produits intermédiaires', groupe: '46.7' },
  '46.77': { label: 'Commerce de gros de déchets et débris', groupe: '46.7' },
  '46.90': { label: 'Commerce de gros non spécialisé', groupe: '46.9' },
  ...
  '47.53': { label: 'Commerce de détail de tapis, moquettes et revêtements de murs et de sols en magasin spécialisé', groupe: '47.5' },
  '47.54': { label: 'Commerce de détail d\'appareils électroménagers en magasin spécialisé', groupe: '47.5' },
  '47.59': { label: 'Commerce de détail de meubles, appareils d\'éclairage et autres articles de ménage en magasin spécialisé', groupe: '47.5' },
  ...
  '47.76': { label: 'Commerce de détail de fleurs, plantes, graines, engrais, animaux de compagnie et aliments pour ces animaux en magasin spécialisé', groupe: '47.7' },
  ...
  '49.10': { label: 'Transport ferroviaire interurbain de voyageurs', groupe: '49.1' },
  '49.20': { label: 'Transports ferroviaires de fret', groupe: '49.2' },
  '49.31': { label: 'Transports urbains et suburbains de voyageurs', groupe: '49.3' },
  '49.32': { label: 'Transports de voyageurs par taxis', groupe: '49.3' },
  '49.39': { label: 'Autres transports terrestres de voyageurs n.c.a.', groupe: '49.3' },
  '49.41': { label: 'Transports routiers de fret', groupe: '49.4' },
  '49.42': { label: 'Services de déménagement', groupe: '49.4' },
  '49.50': { label: 'Transports par conduites', groupe: '49.5' },
  '50.10': { label: 'Transports maritimes et côtiers de passagers', groupe: '50.1' },
  '50.20': { label: 'Transports maritimes et côtiers de fret', groupe: '50.2' },
  '50.30': { label: 'Transports fluviaux de passagers', groupe: '50.3' },
  '50.40': { label: 'Transports fluviaux de fret', groupe: '50.4' },
  '51.10': { label: 'Transports aériens de passagers', groupe: '51.1' },
  '51.21': { label: 'Transports aériens de fret', groupe: '51.2' },
  '51.22': { label: 'Transports spatiaux', groupe: '51.2' },
  '52.10': { label: 'Entreposage et stockage', groupe: '52.1' },
  '52.21': { label: 'Services auxiliaires des transports terrestres', groupe: '52.2' },
  '52.22': { label: 'Services auxiliaires des transports par eau', groupe: '52.2' },
  '52.23': { label: 'Services auxiliaires des transports aériens', groupe: '52.2' },
  '52.24': { label: 'Manutention', groupe: '52.2' },
  '52.29': { label: 'Autres services auxiliaires des transports', groupe: '52.2' },
  '53.10': { label: 'Activités de poste dans le cadre d\'une obligation de service universel', groupe: '53.1' },
  '53.20': { label: 'Autres activités de poste et de courrier', groupe: '53.2' },
  ...
  // Division 58 - Édition
  '58.11': { label: 'Édition de livres', groupe: '58.1' },
  '58.12': { label: 'Édition de répertoires et de fichiers d\'adresses', groupe: '58.1' },
  '58.13': { label: 'Édition de journaux', groupe: '58.1' },
  '58.14': { label: 'Édition de revues et périodiques', groupe: '58.1' },
  '58.19': { label: 'Autres activités d\'édition', groupe: '58.1' },
  '58.21': { label: 'Édition de jeux électroniques', groupe: '58.2' },
  '58.29': { label: 'Édition d\'autres logiciels', groupe: '58.2' },
  // Division 59 - Production de films, vidéo et programmes de télévision ; enregistrement sonore et édition musicale
  '59.11': { label: 'Production de films cinématographiques, de vidéo et de programmes de télévision', groupe: '59.1' },
  '59.12': { label: 'Post-production de films cinématographiques, de vidéo et de programmes de télévision', groupe: '59.1' },
  '59.13': { label: 'Distribution de films cinématographiques, de vidéo et de programmes de télévision', groupe: '59.1' },
  '59.14': { label: 'Projection de films cinématographiques', groupe: '59.1' },
  '59.20': { label: 'Enregistrement sonore et édition musicale', groupe: '59.2' },
  // Division 60 - Programmation et diffusion
  '60.10': { label: 'Édition et diffusion de programmes radio', groupe: '60.1' },
  '60.20': { label: 'Programmation de télévision et télédiffusion', groupe: '60.2' },
  // Division 61 - Télécommunications
  '61.10': { label: 'Télécommunications filaires', groupe: '61.1' },
  '61.20': { label: 'Télécommunications sans fil', groupe: '61.2' },
  '61.30': { label: 'Télécommunications par satellite', groupe: '61.3' },
  '61.90': { label: 'Autres activités de télécommunication', groupe: '61.9' },
  ...
  '64.11': { label: 'Activités de banque centrale', groupe: '64.1' },
  '64.19': { label: 'Autres intermédiations monétaires', groupe: '64.1' },
  '64.20': { label: 'Activités des sociétés holding', groupe: '64.2' },
  '64.30': { label: 'Fonds de placement et entités financières similaires', groupe: '64.3' },
  '64.91': { label: 'Crédit-bail', groupe: '64.9' },
  '64.92': { label: 'Autre distribution de crédit', groupe: '64.9' },
  '64.99': { label: 'Autres activités des services financiers, hors assurance et caisses de retraite, n.c.a.', groupe: '64.9' },
  '65.11': { label: 'Assurance vie', groupe: '65.1' },
  '65.12': { label: 'Autres assurances', groupe: '65.1' },
  '65.20': { label: 'Réassurance', groupe: '65.2' },
  '65.30': { label: 'Caisses de retraite', groupe: '65.3' },
  '66.11': { label: 'Administration de marchés financiers', groupe: '66.1' },
  '66.12': { label: 'Courtage de valeurs mobilières et de marchandises', groupe: '66.1' },
  '66.19': { label: 'Autres activités auxiliaires de services financiers, hors assurance et caisses de retraite', groupe: '66.1' },
  '66.21': { label: 'Évaluation des risques et dommages', groupe: '66.2' },
  '66.22': { label: 'Activités des agents et courtiers d\'assurances', groupe: '66.2' },
  '66.29': { label: 'Autres activités auxiliaires d\'assurance et de caisses de retraite', groupe: '66.2' },
  '66.30': { label: 'Gestion de fonds', groupe: '66.3' },
  ...
  '72.11': { label: 'Recherche-développement en biotechnologie', groupe: '72.1' },
  '72.19': { label: 'Autres activités de recherche-développement en sciences physiques et naturelles', groupe: '72.1' },
  '72.20': { label: 'Recherche-développement en sciences humaines et sociales', groupe: '72.2' },
  ...
  '77.11': { label: 'Location et location-bail de voitures et de véhicules automobiles légers', groupe: '77.1' },
  '77.12': { label: 'Location et location-bail de camions', groupe: '77.1' },
  '77.21': { label: 'Location et location-bail d\'articles de loisirs et de sport', groupe: '77.2' },
  '77.22': { label: 'Location de vidéocassettes et disques vidéo', groupe: '77.2' },
  '77.29': { label: 'Location et location-bail d\'autres biens personnels et domestiques', groupe: '77.2' },
  '77.31': { label: 'Location et location-bail de machines et équipements agricoles', groupe: '77.3' },
  '77.32': { label: 'Location et location-bail de machines et équipements pour la construction', groupe: '77.3' },
  '77.33': { label: 'Location et location-bail de machines de bureau et de matériel informatique', groupe: '77.3' },
  '77.34': { label: 'Location et location-bail de matériels de transport par eau', groupe: '77.3' },
  '77.35': { label: 'Location et location-bail de matériels de transport aérien', groupe: '77.3' },
  '77.39': { label: 'Location et location-bail d\'autres machines, équipements et biens matériels n.c.a.', groupe: '77.3' },
  '77.40': { label: 'Location-bail de propriété intellectuelle et de produits similaires, à l\'exception des œuvres soumises à copyright', groupe: '77.4' },
  '78.10': { label: 'Activités des agences de placement de main-d\'œuvre', groupe: '78.1' },
  '78.20': { label: 'Activités des agences de travail temporaire', groupe: '78.2' },
  '78.30': { label: 'Autre mise à disposition de ressources humaines', groupe: '78.3' },
  '79.11': { label: 'Activités des agences de voyage', groupe: '79.1' },
  '79.12': { label: 'Activités des voyagistes', groupe: '79.1' },
  '79.90': { label: 'Autres services de réservation et activités connexes', groupe: '79.9' },
  '80.10': { label: 'Activités de sécurité privée', groupe: '80.1' },
  '80.20': { label: 'Activités liées aux systèmes de sécurité', groupe: '80.2' },
  '80.30': { label: 'Activités d\'enquête', groupe: '80.3' },
  ...
  '82.91': { label: 'Activités des agences de recouvrement de factures et des sociétés d\'information financière sur la clientèle', groupe: '82.9' },
  ...
  '84.11': { label: 'Administration publique générale', groupe: '84.1' },
  '84.12': { label: 'Administration publique (tutelle) de la santé, de la formation, de la culture et des services sociaux, autre que sécurité sociale', groupe: '84.1' },
  '84.13': { label: 'Administration publique (tutelle) des activités économiques', groupe: '84.1' },
  '84.21': { label: 'Affaires étrangères', groupe: '84.2' },
  '84.22': { label: 'Défense', groupe: '84.2' },
  '84.23': { label: 'Justice', groupe: '84.2' },
  '84.24': { label: 'Activités d\'ordre public et de sécurité', groupe: '84.2' },
  '84.25': { label: 'Services du feu et de secours', groupe: '84.2' },
  '84.30': { label: 'Sécurité sociale obligatoire', groupe: '84.3' },
  
  // ===== Section P - Enseignement =====
  '85.10': { label: 'Enseignement pré-primaire', groupe: '85.1' },
  '85.20': { label: 'Enseignement primaire', groupe: '85.2' },
  '85.31': { label: 'Enseignement secondaire général', groupe: '85.3' },
  '85.32': { label: 'Enseignement secondaire technique ou professionnel', groupe: '85.3' },
  '85.41': { label: 'Enseignement post-secondaire non supérieur', groupe: '85.4' },
  '85.42': { label: 'Enseignement supérieur', groupe: '85.4' },
  '85.51': { label: 'Enseignement de disciplines sportives et d\'activités de loisirs', groupe: '85.5' },
  '85.52': { label: 'Enseignement culturel', groupe: '85.5' },
  '85.53': { label: 'Enseignement de la conduite', groupe: '85.5' },
  '85.59': { label: 'Enseignements divers', groupe: '85.5' },
  '85.60': { label: 'Activités de soutien à l\'enseignement', groupe: '85.6' },
  ...
  '90.01': { label: 'Arts du spectacle vivant', groupe: '90.0' },
  '90.02': { label: 'Activités de soutien au spectacle vivant', groupe: '90.0' },
  '90.03': { label: 'Création artistique', groupe: '90.0' },
  '90.04': { label: 'Gestion de salles de spectacles', groupe: '90.0' },
  '91.01': { label: 'Gestion des bibliothèques et des archives', groupe: '91.0' },
  '91.02': { label: 'Gestion des musées', groupe: '91.0' },
  '91.03': { label: 'Gestion des sites et monuments historiques et des attractions touristiques similaires', groupe: '91.0' },
  '91.04': { label: 'Gestion des jardins botaniques et zoologiques et des réserves naturelles', groupe: '91.0' },
  '92.00': { label: 'Organisation de jeux de hasard et d\'argent', groupe: '92.0' },
  '93.11': { label: 'Gestion d\'installations sportives', groupe: '93.1' },
  '93.12': { label: 'Activités de clubs de sports', groupe: '93.1' },
  '93.13': { label: 'Activités des centres de culture physique', groupe: '93.1' },
  '93.19': { label: 'Autres activités liées au sport', groupe: '93.1' },
  '93.21': { label: 'Activités des parcs d\'attractions et parcs à thèmes', groupe: '93.2' },
  '93.29': { label: 'Autres activités récréatives et de loisirs', groupe: '93.2' },
  
  // ===== Section S - Autres activités de services =====
  '94.11': { label: 'Activités des organisations patronales et consulaires', groupe: '94.1' },
  '94.12': { label: 'Activités des organisations professionnelles', groupe: '94.1' },
  '94.20': { label: 'Activités des syndicats de salariés', groupe: '94.2' },
  '94.91': { label: 'Activités des organisations religieuses', groupe: '94.9' },
  '94.92': { label: 'Activités des organisations politiques', groupe: '94.9' },
  '94.99': { label: 'Activités des organisations associatives n.c.a.', groupe: '94.9' },
  '95.11': { label: 'Réparation d\'ordinateurs et d\'équipements périphériques', groupe: '95.1' },
  '95.12': { label: 'Réparation d\'équipements de communication', groupe: '95.1' },
  '95.21': { label: 'Réparation de produits électroniques grand public', groupe: '95.2' },
  '95.22': { label: 'Réparation d\'appareils électroménagers et d\'équipements pour la maison et le jardin', groupe: '95.2' },
  '95.23': { label: 'Réparation de chaussures et d\'articles en cuir', groupe: '95.2' },
  '95.24': { label: 'Réparation de meubles et d\'équipements du foyer', groupe: '95.2' },
  '95.25': { label: 'Réparation d\'articles d\'horlogerie et de bijouterie', groupe: '95.2' },
  '95.29': { label: 'Réparation d\'autres biens personnels et domestiques', groupe: '95.2' },
  ...
  '97.00': { label: 'Activités des ménages en tant qu\'employeurs de personnel domestique', groupe: '97.0' },
  '98.10': { label: 'Activités indifférenciées des ménages en tant que producteurs de biens pour usage propre', groupe: '98.1' },
  '98.20': { label: 'Activités indifférenciées des ménages en tant que producteurs de services pour usage propre', groupe: '98.2' },
  
  // ===== Section U - Activités extra-territoriales =====
  '99.00': { label: 'Activités des organisations et organismes extraterritoriaux', groupe: '99.0' },
};
