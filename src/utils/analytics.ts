...
export const trackEntrepriseView = (entrepriseId: string, entrepriseName: string, source: 'map' | 'list' | 'activities' | 'tournees' | 'pipeline' | 'analytics') => {
...
export const trackViewChange = (newView: 'map' | 'list' | 'activities' | 'tournees' | 'pipeline' | 'analytics') => {
