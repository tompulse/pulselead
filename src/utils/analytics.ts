...
export const trackEntrepriseView = (entrepriseId: string, entrepriseName: string, source: 'prospects' | 'tournees' | 'crm' | 'donnees') => {
...
export const trackViewChange = (newView: 'prospects' | 'tournees' | 'crm' | 'donnees') => {
