...
export const trackEntrepriseView = (entrepriseId: string, entrepriseName: string, source: 'prospects' | 'tournees' | 'analytics') => {
...
export const trackViewChange = (newView: 'prospects' | 'tournees' | 'analytics') => {
