...
export const trackEntrepriseView = (entrepriseId: string, entrepriseName: string, source: 'map' | 'list' | 'activities' | 'tournees') => {
...
export const trackViewChange = (newView: 'map' | 'list' | 'activities' | 'tournees') => {
